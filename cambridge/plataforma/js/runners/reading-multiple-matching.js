...
export function initReadingMultipleMatching(exercises, skill, part) {
  exercise = null;
  answers  = {};
  _skill   = skill;
  _part    = part;
...
function renderExercise(exercises) {
  ...
  c.innerHTML = `
    <div class="page-header">
      ...
      <p class="page-subtitle">Lee las secciones y relaciona cada pregunta con la persona correcta</p>
    </div>
