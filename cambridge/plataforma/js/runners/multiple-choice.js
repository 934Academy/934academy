...
export function initMultipleChoice(exercises, skill, part) {
  exercise      = null;
  questionIndex = 0;
  answers       = {};
  _skill        = skill;
...
function renderSelector(exercises) {
  ...
  c.innerHTML = `
    <div class="page-header">
      <h1 class="page-title">Part 1 — Multiple Choice Cloze</h1>
...
function renderQuestion(exercises) {
  ...
  c.innerHTML = `
    ...
    <div class="card">
      <div class="card-title">Choose the best word for the gap ${questionIndex + 1}:</div>
